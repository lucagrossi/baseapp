...
export const en = {
 ...
 If you forget you Secret Key, please delete it and apply for a new Secret Key pair.`,
    ...
    'page.body.profile.verification.email.subtitle': 'Opnemen allowed',
    ...
    'page.body.profile.verification.document.subtitle': 'Verhoog opnemen tot een limit van EUR 500,-',
    'page.body.profile.verification.document.rejected.tooltip': 'Uw identiteit is afgekeurd',
    'page.body.profile.verification.address.title': 'Verifieer uw bewijs van woonplaats',
    'page.body.profile.verification.address.subtitle': 'Verhoog opnemen tot een limit van EUR 1000,-',
    ...
    'page.noDataToShow': 'Er is geen data om weer te geven',
