...
export const en = {
    ...
    'page.header.navbar.trade': 'Handel',
    'page.header.navbar.wallets': 'Spelers',
    'page.header.navbar.openOrders': 'Orders',
    'page.header.navbar.history': 'Geschiedenis',
    'page.header.navbar.api': 'API Documentatie',

    'page.header.navbar.profile': 'Profiel',
    'page.header.navbar.logout': 'Logout',

    'page.sidebar.group.text': 'Fee Groep:',
    'page.sidebar.group.value': 'Base',

    'page.body.trade.header.market': 'Spelers markt',
    'page.body.trade.header.yours': 'Jouw spelers',

    'page.body.trade.header.markets': 'Markten',
    'page.body.trade.header.markets.content.market': 'Markt',
    'page.body.trade.header.markets.content.pair': 'Pair',
    'page.body.trade.header.markets.content.price': 'Prijs',
    'page.body.trade.header.markets.content.last_price': 'Laatste Prijs',
    'page.body.trade.header.markets.content.change': 'Change',
    'page.body.trade.header.markets.content.search': 'Zoek',
    'page.body.trade.header.markets.content.volume': 'Volume',

    'page.body.trade.header.newOrder': 'Order Form',
    'page.body.trade.header.newOrder.content.tabs.buy': 'Koop',
    'page.body.trade.header.newOrder.content.tabs.sell': 'Verkoop',
    ...
    'error.order.create.minPrice': 'Prijs is te laag. Minimale prijs is {price} {currency}',
    'error.order.create.maxPrice': 'Prijs is te hoog. Maximale prijs is {price} {currency}',
    'error.order.create.available': 'Saldo te laag. Beschikbaar {available} {currency}',

    'page.body.trade.header.marketDepths': 'Marktdiepte',
    'page.body.trade.header.marketDepths.content.price': 'Prijs:',
    'page.body.trade.header.marketDepths.content.volume': 'Aantal:',
    'page.body.trade.header.marketDepths.content.cumulativeVolume': 'Totaal:',
    'page.body.trade.header.marketDepths.content.cumulativeValue': 'Geschatte waarde:',

    'page.body.trade.toolBar.lowest': 'Laagste 24h',
    'page.body.trade.toolBar.lastPrice': 'Laatste Prijs',
    'page.body.trade.toolBar.selectMarket': 'Selecteer Markt',
    'page.body.trade.toolBar.highest': 'Hoogste 24h',
    'page.body.trade.toolBar.volume': '24h Volume',
    'page.body.trade.toolBar.change': 'Wijziging',

    'page.body.trade.header.asks': 'Asks',
    'page.body.trade.header.bids': 'Bids',
    'page.body.trade.orderbook': 'Order Book',
    'page.body.trade.orderbook.lastMarket': 'Laatste Markt Prijs',
    'page.body.trade.orderbook.header.price': 'Prijs',
    'page.body.trade.orderbook.header.amount': 'Aantal',
    'page.body.trade.orderbook.header.volume': 'Totaal',

    'page.body.trade.header.recentTrades': 'Recente Trades',
    'page.body.trade.header.recentTrades.content.time': 'Tijd',
    'page.body.trade.header.recentTrades.content.price': 'Prijs',
    'page.body.trade.header.recentTrades.content.amount': 'Aantal',

    'page.body.trade.header.openOrders': 'Open Orders',
    'page.body.trade.header.openOrders.content.date': 'Datum',
    'page.body.trade.header.openOrders.content.state': 'Status',
    'page.body.trade.header.openOrders.content.price': 'Prijs',
    'page.body.trade.header.openOrders.content.amount': 'Aantal',
    'page.body.trade.header.openOrders.content.total': 'Waarde',
    'page.body.trade.header.openOrders.content.filled': 'Uitgevoerd',


    /* Markets Table */
    'page.body.marketsTable.filter.all': 'Alles',
    'page.body.marketsTable.header.pair': 'Markt',
    'page.body.marketsTable.header.lastPrice': 'Laatste Prijs',
    'page.body.marketsTable.header.change': '24 Wijziging',
    'page.body.marketsTable.header.high': '24  hoog',
    'page.body.marketsTable.header.low': '24 laag',
    'page.body.marketsTable.header.volume': '24 Volume',


    /* Landing */
    'page.body.landing.header.button1': 'profiel',
    'page.body.landing.header.button2': 'log in',
    'page.body.landing.header.button3': 'registreer',
    ...
    'page.body.landing.register.item.button': 'registreer',
    ...
    'page.body.landing.startTrading.button1': 'registreer',
    ...
    'page.body.profile.header.account.content.password.conf': 'Wachtwoord bevestiging',
    'page.body.profile.header.account.content.password.dont.match': 'Wachtwoorden komen niet overeen',
    'page.body.profile.header.account.content.password.change.success': 'Gelukt!',
    'page.body.profile.header.account.content.password.change': 'Wijzig wachtwoord',

    'page.body.profile.header.account.content.twoFactorAuthentication': '2FA',
    'page.body.profile.header.account.content.twoFactorAuthentication.message.enable': 'Ingeschakeld',
    'page.body.profile.header.account.content.twoFactorAuthentication.message.disable': 'Uitgeschakeld',
    'page.body.profile.header.account.content.twoFactorAuthentication.header': 'Google Authenticator',
    'page.body.profile.header.account.content.twoFactorAuthentication.message.1': 'Download en installeer Google Authenticator app van ',
    'page.body.profile.header.account.content.twoFactorAuthentication.message.or': 'of ',
    'page.body.profile.header.account.content.twoFactorAuthentication.message.2': 'Scan QR code of gebruik geheime MFA code:',
    'page.body.profile.header.account.content.twoFactorAuthentication.message.3': '* Sla deze code op in een geheime locatie. Deze code kan toegang geven vanuit een ander apparaat.',
    'page.body.profile.header.account.content.twoFactorAuthentication.message.mfa': 'MFA code',
    'page.body.profile.header.account.content.twoFactorAuthentication.message.4': 'Voer 2fa code in uit de app',
    'page.body.profile.header.account.content.twoFactorAuthentication.subHeader': '2FA code',
    'page.body.profile.header.account.content.twoFactorAuthentication.enable': 'Schakel in',
    'page.body.profile.header.account.content.twoFactorAuthentication.disable': 'Schakel 2FA uit',
    'page.body.profile.header.account.content.twoFactorAuthentication.modalBody': 'Neem contact op om 2FA uit te schakelen',
    'page.body.profile.header.account.content.twoFactorAuthentication.modalHeader': 'Two-factor authenticatie is ingeschakeld',

    'page.body.profile.header.account.profile': 'Profiel Verificatie',
    'page.body.profile.header.account.profile.email.title': 'Email bevestigd',
    'page.body.profile.header.account.profile.email.message': 'Storten/Opnemen mogelijk',
    'page.body.profile.header.account.profile.phone.unverified.title': 'Telefoon verificatie',
    'page.body.profile.header.account.profile.phone.title': 'Telefoonnummer bevestigd',
    'page.body.profile.header.account.profile.phone.message': 'Storten/Handelen mogelijk',
    'page.body.profile.header.account.profile.identity.unverified.title': 'Identiteit verificatie',
    'page.body.profile.header.account.profile.identity.title': 'Identiteit bevestigd',
 ...
 If you forget you Secret Key, please delete it and apply for a new Secret Key pair.`,
    ...
    'page.body.profile.content.action.requestPasswordReset': 'Vraag om wachtwoord reset',
    'page.body.profile.content.action.passwordReset': 'Wachtwoord reset',
    ...
    'page.body.profile.verification.profile.rejected.tooltip': 'Uw gewijzigde profiel is afgewezen',
    'page.body.profile.verification.document.title': 'Verifieer uw identiteit',
    'page.body.profile.verification.document.subtitle': 'Voor opnames tot een limiet van 500,-',
    'page.body.profile.verification.document.rejected.tooltip': 'Uw identiteit is afgekeurd',
    'page.body.profile.verification.address.title': 'Verifieer uw woonplaats',
    'page.body.profile.verification.address.subtitle': 'Voor opnames tot een limiet van 1000,-',
    'page.body.profile.verification.address.rejected.tooltip': 'Uw bewijs van woonplaats is afgewezen',
    'page.body.profile.verification.pending': 'In behandeling',
    'page.body.profile.verification.reverify': 'Verifieer opnieuw',
    'page.body.profile.verification.verify': 'Verifieer',
    'page.body.profile.verification.verified': 'Vastgesteld',
    'page.body.profile.verification.progress.level': 'Niveau',
    ...
    'page.header.signIn.password': 'Wachtwoord',
    'page.header.signIn.password.message.error': 'Wachtwoord is niet juist',
    'page.header.signIn.receiveConfirmation': 'Didn\'t receive your confirmation email?',
    'page.header.signIn.forgotPassword': 'Uw wachtwoord vergeten?',
    'page.header.signIn.resetPassword.title': 'Reset wachtwoord',
    'page.header.signIn.resetPassword.newPassword': 'Nieuw wachtwoord',
    'page.header.signIn.resetPassword.repeatPassword': 'Herhaal wachtwoord',
    'page.header.signIn.resetPassword.button': 'Wijzig',
    'page.header.signIn.resetPassword.error': 'Velden zijn leeg/komen niet overeen',

    'page.header.signUp': 'Sign Up',
    'page.header.signUp.email': 'Email',
    'page.header.signUp.email.message.error': 'Email klopt niet',
    'page.header.signUp.password': 'Wachtwoord',
    'page.header.signUp.password.message.error': 'Wachtwoord moet minstens 8 karakters bevatten waarvan minimaal 1 hoofdletter en 1 cijfer.',
    'page.header.signUp.confirmPassword': 'Bevestig wachtwoord',
    'page.header.signUp.confirmPassword.message.error': 'Wachtwoorden komen niet overeen',
    'page.header.signUp.referalCode': 'Referentie Code',
    'page.header.signUp.terms': 'I heb de algemene voorwaarden gelezen en begrepen',
    'page.header.signUp.modal.header': 'Bevestig uw emailadres',
    'page.header.signUp.modal.body': 'Om uw registratie af te ronden, check voor een' +
                                      'email in uw inbox voor verdere' +
                                      'instructies. Als u deze mail niet kunt vinden, ' +
                                      'check dan uw spam folder',
    'page.header.signUp.modal.footer': 'OK',
    'page.header.signUp.strength.password': 'Wachtwoord Sterkte',
    'page.header.signUp.password.too.weak': 'TE ZWAK',
    'page.header.signUp.password.weak': 'ZWAK',
    'page.header.signUp.password.good': 'GOED',
    'page.header.signUp.password.strong': 'STERK',
    'page.header.signUp.password.very.strong': 'ZEER STERK',
    'page.resendConfirmation': 'Verstuur Bevestiging opnieuw',
    'page.forgotPassword': 'Wachtwoord vergeten',
    'page.forgotPassword.message': 'Voer email in om wachtwoord te resetten',
    'page.password2fa': '2FA verificatie',
    'page.password2fa.message': 'Voer 2fa code in uit de app',
    'page.forgotPassword.email': 'Email',
    'page.forgotPassword.send': 'Verstuur',
    'page.noDataToShow': 'Geen data om weer te geven',
